...
export function useERC20Allowance({ token, owner, spender, enabled = true }: UseERC20Allowance): {
  ...
  return useMemo(() => ({ tokenAllowance: data, isSyncing: isLoading, refetch }), [data, isLoading, refetch])
}
