...
import { getDataToSignERC2771 } from '../getDataToSignERC2771/index'
...
export async function getSignatureDataERC2771(
  ...
  try {
    ...
    if (isConcurrentRequest(request)) {
      const type = payload.type as ERC2771Type.ConcurrentCallWithSyncFee | ERC2771Type.ConcurrentSponsoredCall
      ...
      const signature = await signTypedDataV4(signerOrProvider, request.user as string, typedData)
      ...
      const type = payload.type as ERC2771Type.CallWithSyncFee | ERC2771Type.SponsoredCall
