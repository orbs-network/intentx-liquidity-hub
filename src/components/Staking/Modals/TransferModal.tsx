...
export default function TransferModal() {
  const isOpen = useModalOpen(ApplicationModal.TRANFER_STAKING)
  const toggle = useToggleModal(ApplicationModal.TRANFER_STAKING)
      ...
      <SplittedModal isOpen={isOpen} onEscapeKeydown={toggle}>
        <Layout>
          <WarnModal height="40px">
            ...
            <Title size="12px">You should know that this transfer is irreversible!</Title>
          </WarnModal>
          <WarnModal height="40px">
            <AlertTriangle size={16} />
            <Title size="12px">Confirm that this wallet is a base network wallet!</Title>
          </WarnModal>
          <ModalContent>
            <Header>
              <ModalHeader2 transfer={true} title="Transfer" subtitle="Transfer Position" onBack={toggle} />
            </Header>
            <Content>
              <Row
                onClick={() => {
              ...
              <RowBetween align="flex-end">
                <Row>
                  <PriceTitleMuted>Transfer to</PriceTitleMuted>
                </Row>
                <RowEnd>
              ...
              <InputModal numerical={false} disabled={false} placeholder="0x" onChange={() => ''}></InputModal>
            </Content>
            <WithdrawButton completed={true}>
              <Title>Transfer Position</Title>
            </WithdrawButton>
          </ModalContent>
        </Layout>
      </SplittedModal>
