...
export default function StakeModal() {
  const isOpen = useModalOpen(ApplicationModal.STAKE_INTX)
  const toggle = useToggleModal(ApplicationModal.STAKE_INTX)
    ...
    <div>
      <SplittedModal isOpen={isOpen} onEscapeKeydown={toggle}>
        <Layout>
          <ModalContent>
            <Header>
              <ModalHeader2 stake={true} title="Stake INTX" onBack={toggle} />
