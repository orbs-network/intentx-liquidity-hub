...
export default function ConversionHeader({ onReload }: { onReload: any }) {
  ...
  //Update condition to show if cross chain is available for user
  const showCrossChainToggle = true
