  ...
  return (
    ...
    >
      {isMobile &&
        option.icon &&
        (option.icon === 'user' ? (
            <UserMobile width={22} height={22}  color={isActive ? '' : '#394353'} />
        ) : option.icon === 'graph' ? (
          <AnalyticsMobile width={22} height={22} color={isActive ? '' : '#394353'} />
        ) : option.icon === 'medaloutline' ? (
          <MedalOutline width={22} height={22} color={isActive ? '' : '#394353'} />
        ) : option.icon === 'users' ? (
          <ReferralsMobile width={22} height={22}  color={isActive ? '' : '#394353'} />
