...
export default function NetworkModal() {
  ...
  const chainMap = useMemo(() => {
    return Object.values(V3_CHAIN_IDS).reduce((acc: SupportedChainId[], id: SupportedChainId, index, arr) => {
      if (chainId === id) {
        return [id, ...acc]
      }
        ...
        {chainMap.map((id, index) => {
          ...
          return (
            ...
            >
              ...
              <Image unoptimized={true} src={Chain.logoUrl} alt={Chain.label} width={30} height={30} />
            </Option>
          )
        })}
      </Wrapper>
