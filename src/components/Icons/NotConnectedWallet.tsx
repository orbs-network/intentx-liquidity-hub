...
export default function NotConnectedWallet({ style = {} }: { style: any; [x: string]: any }) {
  return (
    <div style={style}>
      {/* <svg width={width} height={height} viewBox="0 0 92 96" fill="none" xmlns="http://www.w3.org/2000/svg" {...rest}>
      ...
      <Image unoptimized={true} src={'/images/wallet.svg'} alt="Asset" width={80} height={80} />
    </div>
  )
}
