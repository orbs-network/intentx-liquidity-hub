...
export const Wallet = ({ size = 20, ...rest }: { size?: number; [x: string]: any }) => {
  return (
    <svg width={size} height={size} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" {...rest}>
      ...
      <defs>
        ...
        <linearGradient id="paint1_linear_1910_3951" x1="12" y1="10" x2="20" y2="10" gradientUnits="userSpaceOnUse">
          <stop stopColor="#E5EFF3" />
          <stop offset="0.5" stopColor="#A2D4EA" />
          <stop offset="1" stopColor="#E5EFF3" />
        </linearGradient>
