...
export default function Client({
  ...
  return (
    <svg width={width} height={height} viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg" {...rest}>
      <circle cx="9" cy="5" r="4.5" fill="#383C4B" stroke="url(#paint0_linear_1910_3928)" />
      <path
      ...
      />
      <defs>
        <linearGradient id="paint0_linear_1910_3928" x1="4" y1="5" x2="14" y2="5" gradientUnits="userSpaceOnUse">
