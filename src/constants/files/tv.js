...
!(function () {
  ...
  var o,
    ...
    s,
    d,
    l = "-apple-system, BlinkMacSystemFont, 'Trebuchet MS', Roboto, Ubuntu, sans-serif",
    h = {
      host:
        null == window.location.host.match(/tradingview\.com|pyrrosinvestment\.com/i)
      ...
      calculateWidgetHeight: function (t, e) {
        ...
        return n && e && (this.embedStylesForFullHeight(o + i, r, e), r)
          ? 100 + i
          : r
          ? 'calc(' + o + i + ' - 32px)'
          : o + i
      ...
      css: function (t) {
        ...
        ;(i.type = 'text/css'),
          i.styleSheet ? (i.styleSheet.cssText = t) : ((e = document.createTextNode(t)), i.appendChild(e)),
          o.appendChild(i)
      },
      ...
      isMobileDevice:
        ...
        (o.any = o.Android || o.BlackBerry || o.iOS || o.Opera),
        o),
      ...
      MiniWidget: function (t) {
        ;(this.id = h.gId()),
          (this.options = {
            whitelabel: t.whitelabel || '',
            width: h.WidgetAbstract.prototype.fixSize(t.width) || 300,
            height: h.WidgetAbstract.prototype.fixSize(t.height) || 400,
            symbols: t.symbols,
            tabs: t.tabs || '',
            ...
            large_chart_target: t.large_chart_target || '',
            gridLineColor: t.gridLineColor || '',
            fontColor: t.fontColor || '',
            widgetFontColor: t.widgetFontColor || '',
            underLineColor: t.underLineColor || '',
            underLineBottomColor: t.underLineBottomColor || '',
            trendLineColor: t.trendLineColor || '',
            timeAxisBackgroundColor: t.timeAxisBackgroundColor || '',
            activeTickerBackgroundColor: t.activeTickerBackgroundColor || '',
            noGraph: t.noGraph || !1,
            locale: t.locale,
            styleTickerActiveBg: t.styleTickerActiveBg || '',
            styleTabActiveBorderColor: t.styleTabActiveBorderColor || '',
            styleTickerBodyFontSize: t.styleTickerBodyFontSize || '',
            styleTickerBodyFontWeight: t.styleTickerBodyFontWeight || '',
            styleTickerHeadFontSize: t.styleTickerHeadFontSize || '',
            styleTickerHeadFontWeight: t.styleTickerHeadFontWeight || '',
            styleTickerChangeDownColor: t.styleTickerChangeDownColor || '',
            styleTickerChangeUpColor: t.styleTickerChangeUpColor || '',
            styleTickerLastDownBg: t.styleTickerLastDownBg || '',
            styleTickerLastUpBg: t.styleTickerLastUpBg || '',
            styleTickerSymbolColor: t.styleTickerSymbolColor || '',
            styleTickerSymbolHoverTextDecoration: t.styleTickerSymbolHoverTextDecoration || '',
            styleTickerActiveSymbolTextDecoration: t.styleTickerActiveSymbolTextDecoration || '',
            styleTabsActiveBorderColor: t.styleTabsActiveBorderColor || '',
            styleTabsNoBorder: t.styleTabsNoBorder || '',
            styleWidgetNoBorder: t.styleWidgetNoBorder || '',
      ...
      MediumWidget: function (t) {
        ...
        switch (t.chartType) {
          ...
          case 'bars': {
            const { chartType: e, upColor: i, downColor: n } = t
            o = { chartType: e, upColor: i, downColor: n }
            break
          }
          case 'line': {
            const { chartType: e, color: i, colorGrowing: n, colorFalling: r, lineWidth: a } = t
            o = { chartType: e, color: i, colorGrowing: n, colorFalling: r, lineWidth: a }
            break
          }
          case 'area':
          default: {
      ...
      widget: function (t) {
        ...
        ;(this.options = {
          ...
          container: t.container_id || '',
          toolbar_bg: t.toolbar_bg || 'f4f7f9',
  ...
  ;(h.WidgetAbstract.prototype = {
    ...
    addWrapperFrame: function (t, e, o) {
    ...
    addFooterLogo: function (t, e) {
      e = e || {}
      var o = new URL('https://www.tradingview.com/')
      return (
        h.addUrlParams(o, h.generateUtmForUrlParams(this.options)),
        h.WidgetAbstract.prototype.addWrapperFrame.call(
          this,
          t,
          `<div style="\n\t\t\t\t\tposition:absolute;\n\t\t\t\t\tdisplay: block;\n\t\t\t\t\tbox-sizing: content-box;\n\t\t\t\t\theight: 24px;\n\t\t\t\t\twidth: ${h.WidgetAbstract.prototype.width.call(
            this
          )};\n\t\t\t\t\tbottom: 0;\n\t\t\t\t\tleft: 0;\n\t\t\t\t\tmargin: 0;\n\t\t\t\t\tpadding: 0;\n\t\t\t\t\tfont-family: ${l};\n\t\t\t\t">\n\t\t\t\t\t<div\n\t\t\t\t\t\tstyle="\n\t\t\t\t\t\t\tdisplay: block;\n\t\t\t\t\t\t\tmargin: 0 1px 1px 1px;\n\t\t\t\t\t\t\tline-height: 7px;\n\t\t\t\t\t\t\tbox-sizing: content-box;\n\t\t\t\t\t\t\theight: 11px;\n\t\t\t\t\t\t\tpadding: 6px 10px;\n\t\t\t\t\t\t\ttext-align: right;\n\t\t\t\t\t\t\tbackground: #fff;\n\t\t\t\t\t\t"\n\t\t\t\t\t>\n\t\t\t\t\t\t<a\n\t\t\t\t\t\t\thref="${o.toString()}"\n\t\t\t\t\t\t\ttarget="_blank"\n\t\t\t\t\t\t\tstyle="color: #0099d4; text-decoration: none; font-size: 11px;"\n\t\t\t\t\t\t>\n\t\t\t\t\t\t\t<span style="color: #b4b4b4; font-size: 11px;">${
            e.greyText || 'powered by'
          }</span>\n\t\t\t\t\t\t\t${
    ...
    (h.ChatWidgetEmbed.prototype = {
      ...
      widgetCode: function () {
        ...
        return (
          (t.pathname = '/chatwidgetembed/'),
          h.addUrlParams(t, { whotrades: this.options.whotrades, locale: this.options.locale }),
          h.addUrlParams(t, h.generateUtmForUrlParams(this.options)),
          this.options.room && (t.hash = this.options.room),
          `\n\t\t\t\t<iframe\n\t\t\t\t\tsrc="${t.toString()}"\n\t\t\t\t\t${
    ...
    (h.IdeaWidget.prototype = {
      createWidget: function () {
        ...
        ;(this.postMessage = h.postMessageWrapper(o.contentWindow, this.id)),
          this.postMessage.on(
            'resize',
            function (t) {
              t.id === e.id && (o.style.height = t.height + 'px')
            },
            !0
          )
      },
    ...
    (h.EventsWidget.prototype = {
      ...
      widgetCode: function () {
        ...
        return (
          ...
          h.addUrlParams(t, { currency: this.options.currency, importance: this.options.importance }),
    ...
    (h.MiniWidget.prototype = {
      createWidget: function () {
        var t = this.widgetCode(),
          e = this.options
        if (!e.noLogoOverlay && !e.whitelabel) {
          var o = this.options.greyText || 'Quotes by'
          t = h.WidgetAbstract.prototype.addFooterLogo.call(this, t, { greyText: o, linkText: 'TradingView' })
        }
        c(t, e)
      },
      widgetCode: function () {
        var t = new URL(h.getHost(this.options))
        ;(t.pathname = this.options.customer ? this.options.customer + '/miniwidgetembed/' : '/miniwidgetembed/'),
          h.addUrlParams(
            t,
            {
              width: this.options.width,
              height: this.options.height,
              noGraph: this.options.noGraph,
              locale: this.options.locale,
              whitelabel: this.options.whitelabel ? '1' : '',
            },
            !0
          ),
        ...
        var r = {},
          a = function (t) {
            for (var e = [], o = 0; o < t.length; o++) {
              var i = t[o]
              if (h.isArray(i)) {
                var n = encodeURIComponent(i[0]),
                  a = encodeURIComponent(i[1])
                e.push(n), (r[n] = a)
              } else 'string' == typeof i && e.push(i)
            }
            return e.join(',')
          }
        if (this.options.tabs) {
          o = 0
          for (var s = this.options.tabs.length; o < s; o++) {
            var d = this.options.tabs[o]
            this.options.symbols[d] && t.searchParams.append(d, a(this.options.symbols[d]))
          }
          t.searchParams.append('tabs', this.options.tabs.join(','))
        } else this.options.symbols && t.searchParams.append('symbols', a(this.options.symbols))
        if (this.options.symbols_description)
          for (var l in this.options.symbols_description) r[l] = this.options.symbols_description[l]
        return (
          h.addUrlParams(t, r, !0),
          `\n\t\t\t\t<iframe id="${this.id}"\n\t\t\t\t\tsrc="${t.toString()}"\n\t\t\t\t\twidth="${
            this.options.width
          }"\n\t\t\t\t\t${
            this.options.height ? `height="${this.options.height}"` : ''
    ...
    (h.MediumWidget.prototype = {
      ...
      widgetCode: function () {
        ...
        const i = new URL('/embed-widget/symbol-overview/', h.getHost(this.options))
        return (
    ...
    (h.widget.prototype = {
      create: function () {
        ...
        o && o.parentElement && o.parentElement.removeChild(o),
          ...
          (this.postMessage = h.postMessageWrapper(this.iframe.contentWindow, this.id)),
          h.bindEvent(this.iframe, 'load', function () {
          ...
          e.postMessage.on('logoCreated', function (t) {
            if (t.left && t.bottom && t.width && t.height && t.href) {
              ...
              t.text && ((o.textContent = t.text), (o.style.color = 'transparent')),
                ...
                (e._logoOverlay = o),
                document.getElementById(e.id + '-wrapper').appendChild(o)
            }
          }),
          e.postMessage.on('setLogoOverlayVisibility', function (t) {
            e._logoOverlay &&
              t &&
              'boolean' == typeof t.visible &&
              (e._logoOverlay.style.display = t.visible ? 'inline-block' : 'none')
          }),
          e.postMessage.on('openChartInPopup', function (t) {
            for (var o = h.cloneSimpleObject(e.options), i = ['symbol', 'interval'], n = i.length - 1; n >= 0; n--) {
              var r = i[n],
                a = t[r]
              a && (o[r] = a)
            }
            ...
            var s = e.options.popup_width || 900,
              ...
              g = window.open(
                e.generateUrl(o),
                '_blank',
                'resizable=yes, top=' + c + ', left=' + l + ', width=' + s + ', height=' + d
              )
            g && (g.opener = null)
          })
      },
      ...
      generateUrl: function (t) {
        ...
        function o(e, o) {
          return (o = o || e), void 0 === t[e] ? '' : '&' + encodeURIComponent(o) + '=' + (t[e] ? '1' : '0')
        }

        function i(e, o, i) {
          return (i = i || e), t[e] ? '&' + i + '=' + o : ''
        }

        function n(e, o, i) {
          return (
            (i = i || {}),
            '&' + e + '=' + (t[e] ? encodeURIComponent(JSON.stringify(o)) : encodeURIComponent(JSON.stringify(i)))
          )
        }
        ...
        var a =
          (t.enable_publishing ? h.ideasHost : h.getHost(t)) +
          e +
          '?frameElementId=' +
          this.id +
          '&symbol=' +
          encodeURIComponent(t.symbol) +
          '&interval=' +
          encodeURIComponent(t.interval) +
          (t.range ? '&range=' + encodeURIComponent(t.range) : '') +
          (t.whitelabel ? '&whitelabel=1' : '') +
          (t.hide_top_toolbar ? '&hidetoptoolbar=1' : '') +
          (t.hide_legend ? '&hidelegend=1' : '') +
          o('hide_side_toolbar', 'hidesidetoolbar') +
          o('allow_symbol_change', 'symboledit') +
          o('save_image', 'saveimage') +
          '&toolbarbg=' +
          t.toolbar_bg.replace('#', '') +
          (t.watchlist && t.watchlist.length && t.watchlist.join
            ? '&watchlist=' + encodeURIComponent(t.watchlist.join(''))
            : '') +
          i('editablewatchlist', '1') +
          i('details', '1') +
          i('calendar', '1') +
          i('hotlist', '1') +
          (t.studies && h.isArray(t.studies)
            ? 'string' == typeof t.studies[0]
              ? i('studies', encodeURIComponent(t.studies.join('')))
              : n('studies', t.studies)
            : '') +
          o('horztouchdrag') +
          o('verttouchdrag') +
          i('widgetbar_width', t.widgetbar_width, 'widgetbarwidth') +
          i('hideideas', '1') +
          i('theme', encodeURIComponent(t.theme)) +
          i('style', encodeURIComponent(t.style)) +
          (void 0 === t.extended_hours ? '' : '&extended_hours=' + t.extended_hours) +
          i('timezone', encodeURIComponent(t.timezone)) +
          i('hideideasbutton', '1') +
          i('withdateranges', '1') +
          i('hidevolume', '1') +
          (void 0 === t.padding ? '' : '&padding=' + t.padding) +
          i('show_popup_button', '1', 'showpopupbutton') +
          n('studies_overrides', t.studies_overrides, {}) +
          n('overrides', t.overrides, {}) +
          n('enabled_features', t.enabled_features, []) +
          n('disabled_features', t.disabled_features, []) +
          (t.show_popup_button ? '&showpopupbutton=1' : '') +
          (t.publish_source ? '&publishsource=' + encodeURIComponent(t.publish_source) : '') +
          (t.enable_publishing ? '&enablepublishing=' + encodeURIComponent(t.enable_publishing) : '') +
          (t.venue ? '&venue=' + encodeURIComponent(t.venue) : '') +
          (t.symbology ? '&symbology=' + encodeURIComponent(t.symbology) : '') +
          (t.whotrades ? '&whotrades=' + encodeURIComponent(t.whotrades) : '') +
          (t.locale ? '&locale=' + t.locale : '') +
          (t.referral_id ? '&referral_id=' + t.referral_id : '') +
          (t.no_referral_id ? '&no_referral_id=1' : '') +
          (t.fundamental ? '&fundamental=' + encodeURIComponent(t.fundamental) : '') +
          (t.percentage ? '&percentage=' + encodeURIComponent(t.percentage) : '') +
          '&utm_source=' +
          encodeURI(window.location.hostname) +
          '&utm_medium=' +
          (h.hasCopyright(t.container) ? 'widget_new' : 'widget') +
          (t.type ? '&utm_campaign=' + t.type : '') +
          (t.type && 'chart' === t.type ? '&utm_term=' + encodeURIComponent(t.symbol) : '')
    ...
    (h.chart.prototype = {
      create: function () {
        ...
        var t,
          e = this.render(),
          o = this
        h.chartCssAttached || (h.css(this.renderCss()), (h.chartCssAttached = !0)),
          c(e, this.options),
          (t = document.getElementById(this.id)),
          h.bindEvent(t, 'load', function () {
            var t
            for (o._ready = !0, t = o._ready_handlers.length; t--; ) o._ready_handlers[t].call(o)
          }),
          h.onready(function () {
            var e = !1
            if (
              (document.querySelector && document.querySelector('a[href$="/v/' + o.options.chart + '/"]') && (e = !0),
              !e)
            )
              for (
                var i = document.getElementsByTagName('a'),
                  n = new RegExp('/v/' + o.options.chart + '/$'),
                  r = new RegExp('/chart/([0-9a-zA-Z:+*-/()]+)/' + o.options.chart),
                  a = 0;
                a < i.length;
                a++
              )
                if (n.test(i[a].href) || r.test(i[a].href)) {
                  e = !0
                  break
                }
            e && ((t.src += '#nolinks'), (t.name = 'nolinks'))
          }),
          (this.postMessage = h.postMessageWrapper(t.contentWindow, this.id)),
          this.postMessage.on(
            'toggleFullscreen',
            function (e) {
              t.contentWindow === this.source && o.toggleFullscreen(e.value)
            },
            !0
          )
      },
      ...
      render: function () {
        var t =
          this.options.mobileStatic && this.isMobile
            ? new URL(`${h.host}/embed-static/${this.options.chart}`)
            : new URL(`${h.host}/embed/${this.options.chart}`)
        h.addUrlParams(t, { method: 'script', locale: this.options.locale }, !0),
          (this.options.type = 'chart'),
          h.addUrlParams(t, h.generateUtmForUrlParams(this.options))
        var e = this.options.autosize
          ? 'style="width: 100%; height: 100%; margin: 0 !important; padding: 0 !important;"'
          : `style="width: ${this.options.width}px; height: ${this.options.height}px;"`
        const o = this.options.autosize
          ? 'style="width: 100%; height: 100%; margin: 0 !important; padding: 0 !important;"'
        ...
        t
          ...
          : ((e.style.position = 'static'),
            this.options.autosize
              ...
              : ((e.style.width = this.options.width + 'px'), (e.style.height = this.options.height + 'px')),
    ...
    (h.stream.prototype = {
      ...
      render: function () {
        ...
        h.addUrlParams(t, { locale: this.options.locale }, !0),
          (this.options.type = 'chart'),
          h.addUrlParams(t, h.generateUtmForUrlParams(this.options))
        var e = this.options.autosize
            ? 'style="width: 100%; height: 100%; margin: 0 !important; padding: 0 !important;"'
            : `style="width: ${this.options.width}px; height: ${this.options.height}px;"`,
          o = this.options.autosize
            ? 'style="width: 100%; height: 100%; margin: 0 !important; padding: 0 !important;"'
            : `width="${this.options.width}" height="${this.options.height}"`
        return `\n\t\t\t\t<div class="tradingview-widget"\t${e}>\n\t\t\t\t\t<iframe id="${
          this.id
        ...
        window.addEventListener('message', function (t) {
          ...
          if (e && e.provider && 'TradingView' === e.provider)
            if (((e.source = t.source), 'get' === e.type)) {
              ...
              n[e.client_id] &&
                n[e.client_id][e.id] &&
                (n[e.client_id][e.id].call(e, e.data), delete n[e.client_id][e.id])
            else if ('post' === e.type) {
              if (!r[e.name]) return
              r[e.name].forEach(function (t) {
      ...
      function (t, e) {
        return (
          ...
          (i = t),
          {
            ...
            get: function (t, o, i) {
              var r = { id: s++, type: 'get', name: t, client_id: e, data: o, provider: 'TradingView' }
              ;(n[e][r.id] = i), a[e].postMessage(JSON.stringify(r), '*')
            },
            post: function (t, e, o) {
              var i = { id: d++, type: 'post', name: e, data: o, provider: 'TradingView' }
    ...
    (h.addUrlParams = function (t, e, o) {
      for (var i in e) e.hasOwnProperty(i) && (o ? e[i] : null != e[i]) && t.searchParams.set(i, e[i])
      return t
    })
  var c = function (t, e) {
    ...
    g = function (t, e) {
      for (var o in e) 'object' == typeof e[o] && t.hasOwnProperty(o) ? g(t[o], e[o]) : (t[o] = e[o])
      return t
    }
