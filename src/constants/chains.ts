...
// export const V3_CHAIN_IDS = [SupportedChainId.BASE, SupportedChainId.FANTOM, SupportedChainId.BSC]
export const V3_CHAIN_IDS = [SupportedChainId.BASE]

// export const APP_CHAINS = [base, fantom, bsc]
export const APP_CHAINS = [base, fantom, bsc]
